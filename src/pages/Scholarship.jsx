...
const Scholarship = () => {
  ...
  const Err = ({ field }) =>
    e(field) ? (
      <p className="text-xs text-red-500 mt-1">{e(field).message}</p>
    ) : null;
        ...
        <div className="container max-w-4xl">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground text-sm mt-2">
              Complete all sections accurately to be considered for our
            ...
            <div className="flex justify-between mt-6">
              {STEPS.map((s) => (
                ...
                >
                  ...
                  <span
                    className={`text-xs ${step === s.id ? "font-semibold text-foreground" : "text-muted-foreground"}`}
                  >
                    {s.label}
                  </span>
                </div>
          ...
          {submitted ? (
            <div className="bg-background rounded-lg p-12 text-center border border-border">
              ...
              <p className="text-muted-foreground">
                Thank you, {firstName}. We'll review your application and get
                back to you soon.
              </p>
            </div>
          ) : (
            <form
              ...
              noValidate
              className="bg-background rounded-lg p-6 md:p-10 border border-border shadow-sm"
            >
                ...
                <div className="space-y-5">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={inputCls("homeAddress")}
                  ...
                  <div className="grid sm:grid-cols-3 gap-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className={inputCls("stateOrigin")}
                      >
                ...
                <div className="space-y-5">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        {...register("courseStudy")}
                        className={inputCls("courseStudy")}
              ...
              {step === 3 && (
                <div className="space-y-5">
                  ...
                  <div>
                    <label className={labelCls}>
                      Why do you feel that you would benefit from this
                      scholarship?*
                    </label>
                    <textarea
                      {...register("financialNeed")}
                      rows={5}
                      className={inputCls("financialNeed")}
                  ...
                  <div>
                    <label className={labelCls}>
                      Are you currently receiving any other forms of financial
                      assistance?*
                    </label>
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mb-2">
                      Tell us about yourself, your goals, and how this
                      scholarship will help you achieve them (max 500 words).
                    </p>
                    <textarea
                      {...register("personalStatement")}
                      rows={6}
                      className={inputCls("personalStatement")}
                      placeholder="Type here..."
                    />
              ...
              {step === 4 && (
                <div className="space-y-5">
                  ...
                  <div>
                    <label className={labelCls}>
                      List any leadership roles you've held or community service
                      you've participated in.*
                    </label>
                    <textarea
                      {...register("leadership")}
                      rows={4}
                      className={inputCls("leadership")}
                      placeholder="Type here..."
                    />
                  ...
                  <div>
                    <label className={labelCls}>
                      How do you plan to contribute to your community after
                      completing your studies?*
                    </label>
                    <textarea
                      {...register("communityImpact")}
                      rows={4}
                      className={inputCls("communityImpact")}
                      placeholder="Type here..."
                    />
                    <Err field="communityImpact" />
                  </div>
                  <h4 className="text-base font-heading font-bold pt-4">
                    Referee Information
                  </h4>
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        {...register("refFullName")}
                        className={inputCls("refFullName")}
                      />
                    ...
                    <div>
                      ...
                      <select
                        {...register("refRelationship")}
                        className={inputCls("refRelationship")}
                      >
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={inputCls("refOrganization")}
                      />
                ...
                <div className="space-y-5">
                  ...
                  <div className="pt-4">
                    ...
                    <p className="text-xs text-muted-foreground mb-3">
                      The Codix Charity Foundation may use documents and stories
                      (e.g. photographs, videos, and written submissions) from
                      funded programs to share the program's success with the
                      public, on social media, in print, or in fundraising
                      activities.
                    </p>
                    <p className="text-sm mb-2">
                      Do you consent to the use of your name, photograph, story
                      description, and information about your Codix Charity
                      Foundation involvement in such promotional materials?
                    </p>
                  ...
                  <div className="pt-4 space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={inputCls("confirmName")}
                      />
